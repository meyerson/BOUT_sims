...
do
    ...
    qsub -q $queue -pe 16way 16 -N $runname -cwd -V -m e -A BOUT++_startup -l h_rt=2:00:00 -j y ./subrun.sh $NP ./hlmk $current_dir
...
allruns=${allruns/%,/} #get rid of the last comma
 ...
 qsub -q serial -pe 1way 1 -N "post_bout"_$key -cwd -V -m e -A \
