...
do
    ...
    qsub -q $queue -pe 16way 128 -N $runname -cwd -V -m e -A BOUT++_startup -l h_rt=10:00:00 -j y ./subrun.sh $NP ./hlmk_beta $current_dir
    
    qsub -q vis -pe 1way 16 -N "movie"_$key -cwd -V -m e -A \
	BOUT++_startup -l h_rt=4:00:00 -j y \
     -hold_jid $runname makemovie.py $current_dir $key
