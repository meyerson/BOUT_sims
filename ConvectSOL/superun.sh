...
do
    ...
    cp craig.cxx $current_dir/physics_code.cxx.ref
    ...
    qsub -q $queue -pe 16way 16 -N $runname -cwd -V -m e -A BOUT++_startup -l h_rt=10:00:00 -j y ./subrun.sh $NP ./craig $current_dir
