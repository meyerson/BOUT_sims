...
do
    ...
    cp q3_simp.cxx $current_dir/physics_code.cxx.ref
    #cp q3_simp.cxx   $PWD/data_${lval}/q3_simp.cxx.ref

    
    sed "s/ZMAX = 1/ZMAX = ${lval}/g" BOUT32.inp > temp.inp
    ...
    qsub -q $queue -pe 16way 32 -N $runname -cwd -V -m e -A BOUT++_startup -l h_rt=2:00:00 -j y ./subrun.sh $NP ./q3_simp $current_dir
